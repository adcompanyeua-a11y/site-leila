...
/* Container 1 — Before & After: fotos 3, 4, 6 (side-by-side comparison shots) */
const beforeAfterImages = [t3, t4, t6];

/* Container 2 — Real Transformations: fotos 1, 2, 5, 7 (result shots) */
const realImages = [t1, t2, t5, t7];
