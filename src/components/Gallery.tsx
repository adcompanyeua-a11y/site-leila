...
function AutoSlider({ startIndex = 0 }: { startIndex?: number }) {
  ...
  return (
    <div className="relative aspect-[4/5] overflow-hidden rounded-sm ring-1 ring-border bg-onyx-light">
