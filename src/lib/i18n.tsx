...
const dict: Record<Lang, Dict> = {
  en: {
    ...
    atelier_p1: "Tucked between Beverly Hills tradition and Miami modernity, our private studio is intimate by design. Only three chairs. Only invited guests. Only formaldehyde-free chemistry.",
    atelier_p2: "Every appointment is a quiet ritual — espresso, champagne, and the unhurried craft of transformation.",
    atelier_founded: "Founded in Miami",
    ...
    footer_address: "Brickell Avenue\nMiami, Florida",
  ...
  es: {
    ...
    atelier_p1: "Entre la tradición de Beverly Hills y la modernidad de Miami, nuestro estudio privado es íntimo por diseño. Solo tres sillas. Solo invitadas. Solo química sin formaldehído.",
    atelier_p2: "Cada cita es un ritual silencioso — espresso, champaña y el arte pausado de la transformación.",
    atelier_founded: "Fundado en Miami",
